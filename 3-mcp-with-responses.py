#!/usr/bin/env python3
"""
Test MCP integration using Llama Stack Responses API
...
specified in the tools parameter, and Llama Stack discovers and invokes
tools dynamically.
"""
...
# Configuration
model_id = os.environ.get("INFERENCE_MODEL", "meta-llama/Llama-3.3-70B-Instruct")
llama_stack_port = os.environ.get('LLAMA_STACK_PORT', '8181')
llama_stack_url = f"http://localhost:{llama_stack_port}"
mcp_server_url = "http://0.0.0.0:8181"
mcp_server_label = "Red Hat AI Validation"

print("=" * 80)
print("Testing MCP Server via Llama Stack Responses API")
print("=" * 80)
...
# Create OpenAI client pointing to Llama Stack
